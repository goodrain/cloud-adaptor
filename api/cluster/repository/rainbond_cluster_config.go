...
func NewRainbondClusterConfigRepo(db *gorm.DB) cluster.RainbondClusterConfigRepository {
	return &RainbondClusterConfigRepo{DB: db}
}

//Create create an event
func (t *RainbondClusterConfigRepo) Create(te *models.RainbondClusterConfig) error {
	var old models.RainbondClusterConfig
...
//Get -
func (t *RainbondClusterConfigRepo) Get(clusterID string) (*models.RainbondClusterConfig, error) {
	var rcc models.RainbondClusterConfig
